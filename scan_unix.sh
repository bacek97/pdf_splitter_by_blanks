...
"${0%/*}/modules/PDFSplitterB.sh" "${CHOOSED_FOLDER}/${FILENAME_COLLATE}" "${CHOOSED_FOLDER}" --t "${ARG_T}" --em blanks &&  # "[Name][part]<DATE><TIME>.str#.pdf"

echo "99" && sleep 10
) | "${0%/*}/modules/gui-progress-zenity.sh"
